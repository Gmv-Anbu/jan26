...
const ThankYouPopUp: NextPage = () => {
  return (
    <MainContainer>
      <ContentWrapper>
        <Content>
          <h2>Thank you for signing up</h2>
          <p>The email verification link has been sent to your email.</p>
          <span>
            {' '}
            <strong>Note:</strong> 
            Please check your spam folder if email was not received
          </span>
          <ButtonPrimaryOutline className="custom-btn">Done</ButtonPrimaryOutline>
        </Content>
      </ContentWrapper>
    </MainContainer>
  )
