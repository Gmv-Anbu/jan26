...
const SuccessPopUp: NextPage = () => {
  return (
    <MainContainer>
      <ContentWrapper>
        <Content>
          <h2>Successfully connected to wallet</h2>
          <p>Wallet address: 0x2017182818828182881. Cloud server configuration takes 1-5 minutes, please wait.</p>
          <ButtonPrimaryOutline className="custom-btn">Go to wallet</ButtonPrimaryOutline>
        </Content>
      </ContentWrapper>
    </MainContainer>
  )
