...
const AdminProfile = () => {
  ...
  const inputFields = ['firstName', 'lastName', 'userId', 'userName', 'email']
  const clickHandler = () => {
    setEdit(true)
  }
  ...
  const saveHandler = (e: any) => {
    ...
    e.preventDefault()
    console.log('saveHandler', isFormValid(), form, updateForm, onInputChange)
    if (isFormValid()) {
      const data = {
  ...
  const getUserDetails = (userId) => {
    auth.userProfileDetails(userId).then((data) => {
      ...
      let phone = ''
      if(userData?.countryCode) phone = userData?.countryCode
                  ...
                  <>
                    <FormDiv key={eachItem + i}>
                      ...
                      <input
                        ...
                        readOnly={edit && ['firstName', 'lastName', 'userName'].includes(eachItem) ? false : true}
                        id={eachItem + i}
                        name={eachItem}
