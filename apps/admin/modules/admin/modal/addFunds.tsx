...
const AddFundsModal = (props: any) => {
    ...
    const randomValue = 'SAwSio3g62o132SiSAwo3g62'
    ...
    const CopyToClipboard = () => {
        if(navigator?.clipboard) navigator.clipboard.writeText(randomValue)
    }
                ...
                <ModalContent>
                    <ModalHeader>
                        ...
                        <a onClick={closeModal}>
                            <Image src={`/svgs/wallet-cancel.svg`} alt={`wallet-cancel`} width="20" height="20" />
                        </a>
                    </ModalHeader>
                    <ModalBody>
                        <TabLinks>
                            <a onClick={() => setActiveTab('Deposit crypto')} className={`${activeTab === 'Deposit crypto' ? 'active' : ''}`}>
                                <Image src={`/svgs/arrow-down${activeTab === 'Deposit crypto' ? '-active' : ''}.svg`} alt={`Deposit crypto`} width="16" height="16" />
                                <span>Deposit crypto</span>
                            </a>
                            <a onClick={() => setActiveTab('Buy ETH with card')} className={`${activeTab === 'Buy ETH with card' ? 'active' : ''}`}>
                                <Image src={`/svgs/credit-card${activeTab === 'Buy ETH with card' ? '-active' : ''}.svg`} alt={`Buy ETH with card`} width="16" height="16" />
                        ...
                        <TabContent>
                            <TransferWalletFundsDiv>
                                <div className='img-wrapper'>
                                    <Image src={`/svgs/transfer-wallet.svg`} alt={`transfer-wallet`} width="95" height="95" />
                                </div>
                                <p>Transfer another wallet funds to your wallet address </p>
                            </TransferWalletFundsDiv>
                            <CopyTextToClipboard>
                                <p className='address'>{randomValue}</p>
